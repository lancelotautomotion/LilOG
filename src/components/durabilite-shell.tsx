      ...
      <main className="relative px-[clamp(12px,4vw,48px)] pt-[clamp(92px,11vw,132px)] pb-[clamp(24px,4vw,48px)]">
        ...
        <div className="relative z-[1] mx-auto max-w-[1400px]">
          ...
          <span aria-hidden className="pointer-events-none absolute inset-0 z-20">
            <span
              className="durab-sticker absolute -left-[10px] h-[clamp(34px,5vw,58px)] w-[clamp(34px,5vw,58px)]"
              style={{ ["--r" as string]: "-16deg", top: "calc(-1 * clamp(34px, 5vw, 58px))" }}
            >
              <ChromeStar uid="durab-star-a" />
            </span>
            <span
              className="durab-sticker absolute -right-[10px] h-[clamp(30px,4.4vw,50px)] w-[clamp(30px,4.4vw,50px)]"
              style={{ ["--r" as string]: "14deg", animationDelay: "-2.6s", top: "calc(-1 * clamp(30px, 4.4vw, 50px))" }}
            >
              <HoloSmiley uid="durab-smiley-a" />
            </span>
            <span
              className="durab-sticker absolute -left-[8px] h-[clamp(28px,4vw,46px)] w-[clamp(28px,4vw,46px)]"
            ...
            <span
              className="durab-sticker absolute -right-[8px] h-[clamp(28px,4vw,46px)] w-[clamp(28px,4vw,46px)]"
