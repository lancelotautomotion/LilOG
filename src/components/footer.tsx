      ...
      <div className="footer-cols">
        ...
        {cols.map((c) => (
          <div key={c.h}>
            ...
            <ul>{c.links.map((l) => (
              <li key={l}>
                <a href={l === t.footer.aboutLinks[1] ? "/durabilite" : l === t.footer.aboutLinks[0] ? "/histoire" : l === t.footer.helpLinks[1] ? "/retours" : l === t.footer.helpLinks[0] ? "/livraison" : l === "FAQ" ? "/faq" : "#"}>{l}</a>
              </li>
            ))}</ul>
          </div>
        ))}
