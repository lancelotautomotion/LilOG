...
function parseDescription(html: string): {
  ...
  /* Le HTML arrive déjà assaini : sanitizeDescription s'en charge dans
     products.ts, au moment où la donnée Shopify entre dans l'application.
     Cette fonction ne fait plus que découper en sections. */
