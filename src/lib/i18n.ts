...
export const DICT: Record<LangCode, Dict> = {
  en: {
    ...
    footer: { newsH: "Get on the list",
      ...
      helpLinks: ["Shipping", "Returns", "Authenticity", "FAQ"],
  ...
  fr: {
    ...
    footer: { newsH: "Rejoignez la liste",
      ...
      helpLinks: ["Livraison", "Retours", "Authenticité", "FAQ"],
  ...
  es: {
    ...
    footer: { newsH: "Únete a la lista",
      ...
      helpLinks: ["Envíos", "Devoluciones", "Autenticidad", "FAQ"],
  ...
  it: {
    ...
    footer: { newsH: "Iscriviti alla lista",
      ...
      helpLinks: ["Spedizioni", "Resi", "Autenticità", "FAQ"],
  ...
  de: {
    ...
    footer: { newsH: "Auf die Liste",
      ...
      helpLinks: ["Versand", "Rückgabe", "Echtheit", "FAQ"],
  ...
  ru: {
    ...
    footer: { newsH: "В список",
      ...
      helpLinks: ["Доставка", "Возврат", "Подлинность", "FAQ"],
